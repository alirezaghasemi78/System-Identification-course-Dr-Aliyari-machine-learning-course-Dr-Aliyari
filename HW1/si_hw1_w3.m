...
noise_Low=normrnd(0,0.1,1000,1);
noise_Medium=normrnd(0,1,1000,1);
noise_High=normrnd(0,10,1000,1);
...
y_without_noise=teta1*u1 +teta2*u2 +teta3*(u1+u2);
y= teta1*u1 +teta2*u2 +teta3*(u1+u2+noise(:,nn-1));

X=[u1 u2 (u1+u2+noise(:,nn-1))];
